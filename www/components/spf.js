...
*/
SPFS[4]=[
	["10","decimal",function(){chgINPUTmode('dec');}]
,	["2","binary",function(){chgINPUTmode('bin');}]
,	["8","octal",function(){chgINPUTmode('oct');}]
,	["16","hexadecimal",function(){chgINPUTmode('hex');}]
,	["TC","Timecode",function(){chgINPUTmode('fct');}]
];
SPFS[4].name="ModeChange";

//	debug
SPFS[5]=[
	["Fit","ウインドウのサイズ調整",function(){nas_fitToWindow();}]
...
,	["CHECK","check",function(){pushKey('check');}]
,	["orientation","Orientation",function(){alert("VVVx");}]
];
SPFS[5].name="Debug";
/*
